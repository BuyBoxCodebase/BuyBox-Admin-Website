...
import { TasksImportDialog } from './categories-import-dialog'
import { TasksMutateDrawer } from './categories-mutate-drawer'
            ...
            handleConfirm={async() => {2
              await fetch(
                `${import.meta.env.VITE_BASE_URL}/category/delete`,
                {
                  ...
                  body: JSON.stringify({ categoryId: currentRow.id }),
                }
