...
interface DataTableProps {
  columns: ColumnDef<DeliveryAgent>[]
  data: DeliveryAgent[]
  isLoading?: boolean
  pagination: {
    pageIndex: number
...
export function DeliveryAgentsTable({ 
  ...
  const table = useReactTable({
    ...
    onPaginationChange: (updater) => {
      // This is called when the table's pagination state changes
    ...
    // We handle pagination manually, so don't need this
                ...
                >
                  <div className="flex items-center justify-center">
                    ...
                    >
                      ...
                      <span>Loading Delivery Agents...</span>
                  </div>
                </TableCell>
              </TableRow>
            ) : data.length ? (
